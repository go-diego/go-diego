...
var fetch = __webpack_require__(9).default; //const fetch = require("isomorphic-unfetch");
...
function _handler() {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event, context) {
    var url, headers, grant_type, bodyData, body, options, _ref, _ref2, error, response, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            headers = {
              Authorization: "Basic ".concat("MWU2M2Q5NTJjNDA3NDJlNDk4M2Q1YTkwZDI1MTNjYWU6ODIxOTQ5Y2I1YTMwNDQ2Yzk0Y2U3MTA4OTdmN2NhZTQ="),
              "Content-Type": "application/x-www-form-urlencoded"
            };
            grant_type = "refresh_token";
            bodyData = {
              grant_type: grant_type,
              refresh_token: "AQAzpULUzq4yVSgnA-AX-ducvwfsw2WVuovf_dC0UUYIs6XgUNXgfSyQxgln2D2E0jKXzFK9MeEmYUblgGnW5dVTg9H61WNFhyAWNWADBq82beemy4MuMTm_lOKmbcAxPcWEDA"
            };
            body = Object.keys(bodyData).map(function (key) {
...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
