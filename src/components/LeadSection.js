  ...
  return (
    <StyledSection className="has-background-warning">
      ...
      <div className="content">
        <p>
          For {distanceInWordsToNow(new Date(2014, 5, 24))}, I have spent my
          time creating crisp and dynamic web applications for the healthcare
          sector and Coachella Valley entrepreneurs. I can deliver diverse,
          high-quality software using up-to-date coding platforms and industry
          best practices.
        </p>
