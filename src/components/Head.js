...
const defaultDescription =
  "Hola! I'm Diego. Front-end developer based in Coachella Valley";
const defaultOGURL = "https://godiego.me";
const defaultOGImage = "/open-graph.png";
  ...
  return (
    <NextHead>
      ...
      <link
        ...
        color="#49B882"
      />
      <link key="favicon" href="/favicon.ico" rel="icon" type="image/x-icon" />
      <meta
        key="og_url"
        property="og:url"
